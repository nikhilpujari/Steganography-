<?php
    ...
    $sql1 = "SELECT id FROM sst WHERE (receiver = '$myusername' or user = '$myusername') and imgName='$ImgName'";
    ...
    if($count == 1) {
        ...
        $command = "/usr/local/opt/python/libexec/bin/python decode_sst.py $target_file";
        $output = shell_exec($command);

        $sql2 = "SELECT message FROM sst WHERE user = '$myusername' and imgName='$ImgName'";
