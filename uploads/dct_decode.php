<?php
    ...
    $sql1 = "SELECT id FROM dct WHERE (receiver = '$myusername' or user = '$myusername') and imgName='$ImgName'";
    ...
    if($count == 1) {
        ...
        $command = "/usr/local/opt/python/libexec/bin/python decode_dct.py $target_file";
        $output = shell_exec($command);
        //echo $output;

        $sql2 = "SELECT message FROM dct WHERE user = '$myusername' and imgName='$ImgName'";
