...
if(isset($_FILES['imageFile'])) {
    ...
    $username = $_POST['username'];
        ...
        // if everything is ok, try to upload file and run Python script
        } else {
            if (move_uploaded_file($_FILES["imageFile"]["tmp_name"], $target_file)) {
                ...
                echo "hi";
                $output = shell_exec("/usr/local/opt/python/libexec/bin/python encode_lsb.py $imagePath $secretMessage");
                echo $output;
