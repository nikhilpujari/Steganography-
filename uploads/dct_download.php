    ...
    $username = $_POST['username'];
        ...
        if ($uploadOk !=0){
            if (move_uploaded_file($_FILES["imageFile"]["tmp_name"], $target_file)) {
                ...
                echo "hi";
                $output = shell_exec("/usr/local/opt/python/libexec/bin/python encode_dct.py $imagePath $secretMessage");
                echo $output;
                ...
                $sql1 = "INSERT INTO dct (message,receiver,user,time,cpu,imgName,size,newSize)
