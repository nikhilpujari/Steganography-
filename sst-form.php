...
<head>
  ...
  <title>Spread Spectrum Technique</title>
...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="sst-form.php">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Image Steganography using SST</h1>
    </div><!-- End Page Title -->
